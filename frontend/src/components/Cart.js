  ...
  if (cartItems.length === 0) {
    return (
      <div className={styles.emptyCart}>
        <h2>Giỏ hàng rỗng</h2>
        <img src='https://cdn.vectorstock.com/i/preview-1x/36/29/paper-shopping-bag-emotions-angry-character-emoji-vector-42543629.jpg' style={{width:'100%', height:'300px'}}/>
        <p>Hãy chọn thêm sản phẩm để mua nhé</p>
