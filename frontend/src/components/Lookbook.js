...
const Lookbook = () => {
  ...
  const fetchLooks = useCallback(async () => {
    const newLooks = [
      { id: 1, image: '', season: 'Hè', type: 'Thường ngày', color: 'Trắng' },
      { id: 2, image: '', season: 'Đông', type: 'Đường phố', color: 'Đen' },
      { id: 3, image: '', season: 'Hè', type: 'Thường ngày', color: 'Trắng' },
      { id: 4, image: '', season: 'Đông', type: 'Đường phố', color: 'Đen' },
      { id: 5, image: '', season: 'Hè', type: 'Thường ngày', color: 'Trắng' },
      { id: 6, image: '', season: 'Đông', type: 'Đường phố', color: 'Đen' },
    ];
  ...
  return (
    <div className={styles.lookbookContainer}>
      <h1 className={styles.lookbookTitle}>Bộ Sưu Tập PomDu</h1>
